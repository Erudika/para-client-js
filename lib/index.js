...
ParaClient.prototype.voteUp = function (obj, voterid, fn) {
	...
	return this.getEntity(this.invokePatch(obj.getObjectURI(), {"_voteup": voterid})).then(function (result) {
		var res = result === "true";
		fn(res);
		return res;
	});
...
ParaClient.prototype.voteDown = function (obj, voterid, fn) {
	...
	return this.getEntity(this.invokePatch(obj.getObjectURI(), {"_votedown": voterid})).then(function (result) {
		var res = result === "true";
		fn(res);
		return res;
	});
