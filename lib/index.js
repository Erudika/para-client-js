...
export default class ParaClient {
  constructor(accessKey, secretKey, options) {
    ...
    this.invokeGet = function (resourcePath, params) {
      return invokeSignedRequest("GET", that.endpoint, that.getFullPath(resourcePath), null, params);
    };
    ...
    this.invokePost = function (resourcePath, entity) {
      return invokeSignedRequest("POST", that.endpoint, that.getFullPath(resourcePath), null, null, entity);
    };
    ...
    this.invokePut = function (resourcePath, entity) {
      return invokeSignedRequest("PUT", that.endpoint, that.getFullPath(resourcePath), null, null, entity);
    };
    ...
    this.invokePatch = function (resourcePath, entity) {
      return invokeSignedRequest("PATCH", that.endpoint, that.getFullPath(resourcePath), null, null, entity);
    };
    ...
    this.invokeDelete = function (resourcePath, params) {
      return invokeSignedRequest("DELETE", that.endpoint, that.getFullPath(resourcePath), null, params);
    };
