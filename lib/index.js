...
function resolve(obj) {
	return new Promise(function (resolve, no) {
		resolve(obj);
	});
}
 ...
 */
ParaClient.prototype.typesCount = function (fn) {
 ...
 */
ParaClient.prototype.voteUp = function (obj, voterid, expiresAfter, lockedAfter, fn) {
 ...
 * @returns {RSVP.Promise} true if vote was successful
 */
ParaClient.prototype.voteDown = function (obj, voterid, expiresAfter, lockedAfter, fn) {
	fn = isFunction(expiresAfter) ? expiresAfter : (fn || noop);
	fn = fn || noop;
	if (!obj || isEmpty(voterid)) {
		fn(false);
...
const _ParaObject = ParaObject;
export { _ParaObject as ParaObject };
const _Pager = Pager;
export { _Pager as Pager };
const _Constraint = Constraint;
export { _Constraint as Constraint };
